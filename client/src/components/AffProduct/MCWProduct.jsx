...
// English Images
import enImage1 from "../../assets/affiliateImages/banner_mcw-sports_bn-scaled.jpg";
import enImage2 from "../../assets/affiliateImages/banner_mcw-casino_bn-scaled.jpg";
import enImage3 from "../../assets/affiliateImages/banner_mcw-slots_bn-scaled.jpg";
import enImage4 from "../../assets/affiliateImages/banner_mcw-table_bn-scaled.jpg";
import enImage5 from "../../assets/affiliateImages/banner_mcw-lottery_bn-scaled.jpg";
import enImage6 from "../../assets/affiliateImages/banner_mcw-promotion_bn-scaled.jpg";
    ...
    <div className="bg-AffiliatePrimaryBg">
      <div className="max-w-7xl mx-auto w-full p-4">
        <h2 className="text-3xl font-bold text-white mb-6 text-center">
          <span className="text-textSecondaryColor">MCW</span>{' '}
